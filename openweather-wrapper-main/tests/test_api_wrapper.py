...
class TestOpenWeather(unittest.TestCase):
    ...
    def test_get_hourly_forecast(self, mock_get):
        ...
        mock_response.status_code = 200
        mock_response.json.return_value = {
            "list": [{"dt_txt": "2024-10-24 12:00:00", "main": {"temp": 285.15}}]
        }
        mock_get.return_value = mock_response
        ...
        self.assertEqual(hourly_forecast[0]["dt_txt"], "2024-10-24 12:00:00")
    ...
    def test_get_seven_day_forecast(self, mock_get):
        ...
        self.assertEqual(seven_day_forecast[0]["dt_txt"], "2024-10-24 12:00:00")
    ...
    def test_plot_weather(self, mock_get):
        ...
        mock_response.status_code = 200
        mock_response.json.return_value = {
            "list": [{"dt_txt": "2025-10-24 12:00:00", "main": {"temp": 285.15}}]
        }
        mock_get.return_value = mock_response
